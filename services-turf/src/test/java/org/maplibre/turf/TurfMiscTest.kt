...
class TurfMiscTest {
    ...
    fun lineSlice_throwsStartStopPointException() {
        val point = Point.fromLngLat(1.0, 1.0)
        val point2 = Point.fromLngLat(2.0, 2.0)
    ...
    fun testTurfLineSliceLine1() {
        val start = Point.fromLngLat(-97.79617309570312, 22.254624939561698)
        val stop = Point.fromLngLat(-97.72750854492188, 22.057641623615734)
    ...
    fun testTurfLineSliceLine2() {
        val start = Point.fromLngLat(0.0, 0.1)
        val stop = Point.fromLngLat(.9, .8)

        val coordinates = listOf(
            Point.fromLngLat(0.0, 0.0),
            Point.fromLngLat(1.0, 1.0)
        )
        val line2 = LineString.fromLngLats(coordinates)
    ...
    fun testTurfLineSliceRoute1() {
        val start = Point.fromLngLat(-79.0850830078125, 37.60117623656667)
        val stop = Point.fromLngLat(-77.7667236328125, 38.65119833229951)
    ...
    fun testTurfLineSliceRoute2() {
        val start = Point.fromLngLat(-112.60660171508789, 45.96021963947196)
        val stop = Point.fromLngLat(-111.97265625, 48.84302835299516)
    ...
    fun testTurfLineSliceVertical() {
        val start = Point.fromLngLat(-121.25447809696198, 38.70582415504791)
        val stop = Point.fromLngLat(-121.25447809696198, 38.70634324369764)
   ...
   */
    ...
    fun pointOnLine_throwLineMustContainTwoOrMorePoints() {
        val line = listOf(
            Point.fromLngLat(-122.45717525482178, 37.72003306385638)
        )
    ...
    fun testTurfPointOnLineFirstPoint() {
        val pt = Point.fromLngLat(-122.45717525482178, 37.72003306385638)
        val line = listOf(
            pt,
            Point.fromLngLat(-122.45717525482178, 37.718242366859215)
    ...
    fun testTurfPointOnLinePointsBehindFirstPoint() {
        ...
        val pts = listOf(
            Point.fromLngLat(-122.45717525482178, 37.72009306385638),
            Point.fromLngLat(-122.45717525482178, 37.82009306385638),
            Point.fromLngLat(-122.45716525482177, 37.72009306385638),
            Point.fromLngLat(-122.45516525482178, 37.72009306385638),
        )
    ...
    fun testTurfPointOnLinePointsInFrontOfLastPoint() {
        val line = listOf(
            Point.fromLngLat(-122.45616137981413, 37.72125936929241),
            Point.fromLngLat(-122.45717525482178, 37.72003306385638),
            Point.fromLngLat(-122.45717525482178, 37.718242366859215),
        )

        val pts = listOf(
            Point.fromLngLat(-122.45696067810057, 37.7181405249708),
            Point.fromLngLat(-122.4573630094528, 37.71813203814049),
            Point.fromLngLat(-122.45730936527252, 37.71797927502795),
            Point.fromLngLat(-122.45718061923981, 37.71704571582896)
        )
    ...
    fun testTurfPointOnLinePointsOnJoints() {
        ...
        val line2 = listOf(
            Point.fromLngLat(26.279296875, 31.728167146023935),
            Point.fromLngLat(21.796875, 32.69486597787505),
            Point.fromLngLat(18.80859375, 29.99300228455108),
            Point.fromLngLat(12.919921874999998, 33.137551192346145),
            Point.fromLngLat(10.1953125, 35.60371874069731),
            Point.fromLngLat(4.921875, 36.527294814546245),
            Point.fromLngLat(-1.669921875, 36.527294814546245),
            Point.fromLngLat(-5.44921875, 34.74161249883172),
            Point.fromLngLat(-8.7890625, 32.99023555965106)
        )

        val line3 = listOf(
            Point.fromLngLat(-0.10919809341430663, 51.52204224896724),
            Point.fromLngLat(-0.10923027992248535, 51.521942114455435),
            Point.fromLngLat(-0.10916590690612793, 51.52186200668747),
            Point.fromLngLat(-0.10904788970947266, 51.52177522311313),
            Point.fromLngLat(-0.10886549949645996, 51.521601655468345),
            Point.fromLngLat(-0.10874748229980469, 51.52138135712038),
            Point.fromLngLat(-0.10855436325073242, 51.5206870765674),
            Point.fromLngLat(-0.10843634605407713, 51.52027984939518),
            Point.fromLngLat(-0.10839343070983887, 51.519952729849024),
            Point.fromLngLat(-0.10817885398864746, 51.51957887606202),
            Point.fromLngLat(-0.10814666748046874, 51.51928513164789),
            Point.fromLngLat(-0.10789990425109863, 51.518624199789016),
            Point.fromLngLat(-0.10759949684143065, 51.51778299991493)
        )

        val lines = listOf(line1, line2, line3)

        for (line in lines) {
            val linePoint = line.map { pt -> Point.fromLngLat(pt.longitude(), pt.latitude()) }
    ...
    fun testTurfPointOnLinePointsOnTopOfLine() {
        ...
        val dist = length(LineString.fromLngLats(line), TurfConstants.UNIT_MILES)
    ...
    fun testTurfPointOnLinePointAlongLine() {
        val line = listOf(
            Point.fromLngLat(-122.45717525482178, 37.7200330638563),
            Point.fromLngLat(-122.45717525482178, 37.718242366859215),
        )
    ...
    fun testTurfPointOnLinePointsOnSidesOfLines() {
        ...
        val pts = listOf(
            Point.fromLngLat(-122.45702505111694, 37.71881098149625),
            Point.fromLngLat(-122.45733618736267, 37.719235317933844),
            Point.fromLngLat(-122.45686411857605, 37.72027068864082),
            Point.fromLngLat(-122.45652079582213, 37.72063561093274)
        )
    ...
    fun testShortLine() {
        ...
        val lineStringLine1 = LineString.fromLngLats(
            listOf(
